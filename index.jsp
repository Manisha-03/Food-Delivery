...
<html>
    <head>
        ...
        <title>Manisha's Restaurant!</title>
    ...
    <fieldset style="width:270px;float:right;border:3px solid black;background:white">
        <form method="post" action="login.jsp" class="w3-container">
           ...
           <div class="w3-xxlarge"> Welcome to Online Restaurant!<br> grab it now!!</div>
           </div>
            </center>
<div class="w3-container w3-section w3-red">
<span onclick="this.parentElement.style.display='none'" class="w3-closebtn">&times;</span>
  <h5>how was your experience with FoodMania!&nbsp &nbsp &nbsp &nbsp<a href=""><input type="button" class="w3-btn w3-hover-purple" value="Give feedbaack"></a></h5>
  <p></p>
</div>
...
<div class="w3-container w3-black w3-center w3-allerta">
<p class="w3-xxlarge">Manisha Kaushal</p>
</div>
</body>
</html>
