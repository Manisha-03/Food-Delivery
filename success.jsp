...
%>
<html>
<head><title>Welcome to FoodMania | A Complete Meal.</title>
...
<div id="header">
		<div>
			<div class="logo">
				<a href="index.html">THE FOOD MANIA</a>
...
&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp The Food Mania
