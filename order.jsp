   ...
   if (sports != null) 
   {
      for (int i = 0; i < sports.length; i++) 
      {
    	  ...
    	  rs = st.getResultSet ();
	   	 while (rs.next ())
	     {
	          nameVal = rs.getString ("item_name");
	          catVal = rs.getInt ("price_rupee");
...
"<tr><td>"+nameVal+"</td><td>"+q+"</td><td><div id='total1'>"+catVal+"</div></td></tr>");
        ...
        st.executeUpdate("insert into admin values('"+uname+"','"+nameVal+"',"+catVal+")");
      out.print("<form action='post.jsp'><tr><td style='font-size:30px;'>Total</td><td style='font-size:30px;'>"+count/2+"</td><td style='font-size:30px;'>"+sum+"</td></tr>");
      out.print("<tr></tr><tr><td></td><td><div><input type='submit' class='w3-btn w3-xlarge' value='Proceed to Checkout'> </div></td></tr></form>");
   }
   else {
   %>
<tr><td></td></tr></td></tr>
